...
Use this for every product team migrating to the current stable `6.2.0` GDS adoption-platform release.

## Copy/paste message for 6.2.0 after publish verification

Team, we completed the GDS upgrade to the 6.2.0 adoption platform release.
...
- Update dependencies:
  ...
  - `@sovereignsquad/gds-compliance@6.2.0` (dev)
- If you use granular packages, keep every GDS package on the same version:
  - `@sovereignsquad/gds-theme@6.2.0`
  - `@sovereignsquad/gds-core@6.2.0`
  - `@sovereignsquad/gds-admin@6.2.0`
