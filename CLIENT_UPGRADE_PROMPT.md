...
Use this for every product team migrating to the current stable `3.9.0` GDS adoption-platform release.

## Copy/paste message for 3.9.0 after publish verification
