...
Use this for every product team migrating to the current stable `4.1.3` GDS adoption-platform release.

## Copy/paste message for 4.1.3 after publish verification

Team, we completed the GDS upgrade to the 4.1.3 adoption platform release.
...
- Update dependencies:
  ...
  - `@sovereignsquad/gds-eslint-config@4.1.3` (dev)
  - `@sovereignsquad/gds-compliance@4.1.3` (dev)
