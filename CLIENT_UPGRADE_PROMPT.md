...
Use this for every product team migrating to the current stable `4.1.7` GDS adoption-platform release.

## Copy/paste message for 4.1.7 after publish verification

Team, we completed the GDS upgrade to the 4.1.7 adoption platform release.
...
- Update dependencies:
  - `@sovereignsquad/gds@4.1.7`
  - `@sovereignsquad/gds-eslint-config@4.1.7` (dev)
  - `@sovereignsquad/gds-compliance@4.1.7` (dev)
- If you use granular packages, keep every GDS package on the same version:
  - `@sovereignsquad/gds-theme@4.1.7`
  - `@sovereignsquad/gds-core@4.1.7`
  - `@sovereignsquad/gds-admin@4.1.7`
