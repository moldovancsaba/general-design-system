...
Use this for every product team migrating to the current stable `3.0.5` GDS adoption-platform release.

## Copy/paste message for 3.0.5 after publish verification

Team, we completed the GDS upgrade to the 3.0.5 adoption platform release.

- Update dependencies:
  - `@doneisbetter/gds@3.0.5`
  - `@doneisbetter/gds-eslint-config@3.0.5` (dev)
  - `@doneisbetter/gds-compliance@3.0.5` (dev)
- If you use granular packages, keep every GDS package on the same version:
  - `@doneisbetter/gds-theme@3.0.5`
  - `@doneisbetter/gds-core@3.0.5`
  - `@doneisbetter/gds-admin@3.0.5`
