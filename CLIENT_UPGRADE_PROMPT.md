...
Use this for every product team migrating to the current stable `3.0.1` GDS adoption-platform release.

## Copy/paste message for 3.0.1 after publish verification

Team, we completed the GDS upgrade to the 3.0.1 adoption platform release.

- Update dependencies:
  - `@doneisbetter/gds@3.0.1`
  - `@doneisbetter/gds-eslint-config@3.0.1` (dev)
  - `@doneisbetter/gds-compliance@3.0.1` (dev)
- If you use granular packages, keep every GDS package on the same version:
  - `@doneisbetter/gds-theme@3.0.1`
  - `@doneisbetter/gds-core@3.0.1`
  - `@doneisbetter/gds-admin@3.0.1`
