...
Use this for every product team migrating to the current stable `6.3.0` GDS adoption-platform release.

## Copy/paste message for 6.3.0 after publish verification

Team, we completed the GDS upgrade to the 6.3.0 adoption platform release.
...
- Update dependencies:
  - `@sovereignsquad/gds@6.3.0`
  - `@sovereignsquad/gds-eslint-config@6.3.0` (dev)
  - `@sovereignsquad/gds-compliance@6.3.0` (dev)
- If you use granular packages, keep every GDS package on the same version:
  - `@sovereignsquad/gds-theme@6.3.0`
  - `@sovereignsquad/gds-core@6.3.0`
  - `@sovereignsquad/gds-admin@6.3.0`
