...
Use this for every product team migrating to the current stable `3.5.0` GDS adoption-platform release.

## Copy/paste message for 3.5.0 after publish verification

Team, we completed the GDS upgrade to the 3.5.0 adoption platform release.

- Update dependencies:
  - `@doneisbetter/gds@3.5.0`
  - `@doneisbetter/gds-eslint-config@3.5.0` (dev)
  - `@doneisbetter/gds-compliance@3.5.0` (dev)
