...
Use this for every product team migrating to the current stable `3.14.17` GDS adoption-platform release.

## Copy/paste message for 3.14.17 after publish verification

Team, we completed the GDS upgrade to the 3.14.17 adoption platform release.
