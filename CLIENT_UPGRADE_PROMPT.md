...
Use this for every product team migrating to the current stable `3.4.9` GDS adoption-platform release.

## Copy/paste message for 3.4.9 after publish verification

Team, we completed the GDS upgrade to the 3.4.9 adoption platform release.

- Update dependencies:
  - `@doneisbetter/gds@3.4.9`
  - `@doneisbetter/gds-eslint-config@3.4.9` (dev)
  - `@doneisbetter/gds-compliance@3.4.9` (dev)
- If you use granular packages, keep every GDS package on the same version:
  - `@doneisbetter/gds-theme@3.4.9`
  - `@doneisbetter/gds-core@3.4.9`
  - `@doneisbetter/gds-admin@3.4.9`
