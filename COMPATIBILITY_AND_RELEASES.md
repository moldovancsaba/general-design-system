...
- published baseline (GitHub Packages): `3.14.6`
- current repository line: `3.14.6`
...
For the current `3.14.6` line, the install contract is (requires the `.npmrc` block above):

```bash
npm install @sovereignsquad/gds@3.14.6
npm install -D @sovereignsquad/gds-eslint-config@3.14.6 @sovereignsquad/gds-compliance@3.14.6
```

Granular consumers should use the same version across every package:

```bash
npm install @sovereignsquad/gds-theme@3.14.6 @sovereignsquad/gds-core@3.14.6 @sovereignsquad/gds-admin@3.14.6
npm install -D @sovereignsquad/gds-eslint-config@3.14.6 @sovereignsquad/gds-compliance@3.14.6
```

Do not mix pre-3.0 package lines with `3.14.6` packages in the same consumer dependency graph.
