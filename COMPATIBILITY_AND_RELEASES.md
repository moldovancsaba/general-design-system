...
- published baseline (GitHub Packages): `3.11.1`
- current repository line: `3.11.1`
...
For the current `3.11.1` line, the install contract is (requires the `.npmrc` block above):

```bash
npm install @sovereignsquad/gds@3.11.1
npm install -D @sovereignsquad/gds-eslint-config@3.11.1 @sovereignsquad/gds-compliance@3.11.1
```

Granular consumers should use the same version across every package:

```bash
npm install @sovereignsquad/gds-theme@3.11.1 @sovereignsquad/gds-core@3.11.1 @sovereignsquad/gds-admin@3.11.1
npm install -D @sovereignsquad/gds-eslint-config@3.11.1 @sovereignsquad/gds-compliance@3.11.1
```

Do not mix pre-3.0 package lines with `3.11.1` packages in the same consumer dependency graph.
