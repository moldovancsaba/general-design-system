...
- published npm baseline: `3.0.2`
- current repository line: `3.0.2`
...
For the current `3.0.2` line, the install contract is:
...
Do not mix pre-3.0 package lines with `3.0.2` packages in the same consumer dependency graph.
...
```bash
npm install \
  https://github.com/sovereignsquad/general-design-system/releases/download/gds-v3.0.2/doneisbetter-gds-theme-3.0.2.tgz \
  https://github.com/sovereignsquad/general-design-system/releases/download/gds-v3.0.2/doneisbetter-gds-core-3.0.2.tgz \
  https://github.com/sovereignsquad/general-design-system/releases/download/gds-v3.0.2/doneisbetter-gds-admin-3.0.2.tgz

npm install -D \
  https://github.com/sovereignsquad/general-design-system/releases/download/gds-v3.0.2/doneisbetter-gds-eslint-config-3.0.2.tgz \
  https://github.com/sovereignsquad/general-design-system/releases/download/gds-v3.0.2/doneisbetter-gds-compliance-3.0.2.tgz
```
