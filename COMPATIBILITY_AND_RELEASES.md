...
- published npm baseline: `3.4.3`
- current repository line: `3.4.3`
...
For the current `3.4.3` line, the install contract is:
...
Do not mix pre-3.0 package lines with `3.4.3` packages in the same consumer dependency graph.
...
```bash
npm install \
  https://github.com/sovereignsquad/general-design-system/releases/download/gds-v3.4.3/doneisbetter-gds-theme-3.4.3.tgz \
  https://github.com/sovereignsquad/general-design-system/releases/download/gds-v3.4.3/doneisbetter-gds-core-3.4.3.tgz \
  https://github.com/sovereignsquad/general-design-system/releases/download/gds-v3.4.3/doneisbetter-gds-admin-3.4.3.tgz

npm install -D \
  https://github.com/sovereignsquad/general-design-system/releases/download/gds-v3.4.3/doneisbetter-gds-eslint-config-3.4.3.tgz \
  https://github.com/sovereignsquad/general-design-system/releases/download/gds-v3.4.3/doneisbetter-gds-compliance-3.4.3.tgz
```
