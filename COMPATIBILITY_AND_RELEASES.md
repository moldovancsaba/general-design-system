...
- published baseline (GitHub Packages): `3.14.3`
- current repository line: `3.14.3`
...
For the current `3.14.3` line, the install contract is (requires the `.npmrc` block above):

```bash
npm install @sovereignsquad/gds@3.14.3
npm install -D @sovereignsquad/gds-eslint-config@3.14.3 @sovereignsquad/gds-compliance@3.14.3
```

Granular consumers should use the same version across every package:

```bash
npm install @sovereignsquad/gds-theme@3.14.3 @sovereignsquad/gds-core@3.14.3 @sovereignsquad/gds-admin@3.14.3
npm install -D @sovereignsquad/gds-eslint-config@3.14.3 @sovereignsquad/gds-compliance@3.14.3
```

Do not mix pre-3.0 package lines with `3.14.3` packages in the same consumer dependency graph.
