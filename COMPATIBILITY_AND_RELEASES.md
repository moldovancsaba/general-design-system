...
- published npm baseline: `3.4.12`
- current repository line: `3.4.12`
...
For the current `3.4.12` line, the install contract is:

```bash
npm install @doneisbetter/gds@3.4.12
npm install -D @doneisbetter/gds-eslint-config@3.4.12 @doneisbetter/gds-compliance@3.4.12
```

Granular consumers should use the same version across every package:

```bash
npm install @doneisbetter/gds-theme@3.4.12 @doneisbetter/gds-core@3.4.12 @doneisbetter/gds-admin@3.4.12
npm install -D @doneisbetter/gds-eslint-config@3.4.12 @doneisbetter/gds-compliance@3.4.12
```

Do not mix pre-3.0 package lines with `3.4.12` packages in the same consumer dependency graph.
...
```bash
npm install \
  https://github.com/sovereignsquad/general-design-system/releases/download/gds-v3.4.12/doneisbetter-gds-theme-3.4.12.tgz \
  https://github.com/sovereignsquad/general-design-system/releases/download/gds-v3.4.12/doneisbetter-gds-core-3.4.12.tgz \
  https://github.com/sovereignsquad/general-design-system/releases/download/gds-v3.4.12/doneisbetter-gds-admin-3.4.12.tgz

npm install -D \
  https://github.com/sovereignsquad/general-design-system/releases/download/gds-v3.4.12/doneisbetter-gds-eslint-config-3.4.12.tgz \
  https://github.com/sovereignsquad/general-design-system/releases/download/gds-v3.4.12/doneisbetter-gds-compliance-3.4.12.tgz
```
