...
- **GDS-side findings** were produced by directly reading source
  ...
  `packages/gds-a11y`) and the current SSOT docs at `v4.1.5` — not inferred
...
| Dimension | GDS (v4.1.5) | Material 3 | Fluent 2 | Carbon | Ant Design 5 | Polaris / Spectrum / Atlassian / Chakra |
|---|---|---|---|---|---|---|
