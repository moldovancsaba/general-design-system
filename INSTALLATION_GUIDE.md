...
- current stable package line: `4.0.0`
...
Preferred `4.0.0` runtime package:

```bash
npm install @sovereignsquad/gds@4.0.0
```

Governance packages:

```bash
npm install -D @sovereignsquad/gds-eslint-config@4.0.0 @sovereignsquad/gds-compliance@4.0.0 @sovereignsquad/gds-a11y@4.0.0
```

Granular runtime packages when package separation is intentional:

```bash
npm install @sovereignsquad/gds-theme@4.0.0 @sovereignsquad/gds-core@4.0.0 @sovereignsquad/gds-admin@4.0.0
npm install -D @sovereignsquad/gds-eslint-config@4.0.0 @sovereignsquad/gds-compliance@4.0.0 @sovereignsquad/gds-a11y@4.0.0
```
...
2. Switch to the recommended umbrella at the current version: `npm install @sovereignsquad/gds@4.0.0` (it re-exports `gds-core`, `gds-theme`, and `gds-admin`, so you depend on one package instead of several). If you prefer to keep the split packages, install `@sovereignsquad/gds-core@4.0.0` / `@sovereignsquad/gds-theme@4.0.0` instead — both resolve from GitHub Packages.
