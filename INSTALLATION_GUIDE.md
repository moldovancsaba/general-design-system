...
- current stable package line: `3.15.0`
...
Preferred `3.15.0` runtime package:

```bash
npm install @sovereignsquad/gds@3.15.0
```

Governance packages:

```bash
npm install -D @sovereignsquad/gds-eslint-config@3.15.0 @sovereignsquad/gds-compliance@3.15.0 @sovereignsquad/gds-a11y@3.15.0
```

Granular runtime packages when package separation is intentional:

```bash
npm install @sovereignsquad/gds-theme@3.15.0 @sovereignsquad/gds-core@3.15.0 @sovereignsquad/gds-admin@3.15.0
npm install -D @sovereignsquad/gds-eslint-config@3.15.0 @sovereignsquad/gds-compliance@3.15.0 @sovereignsquad/gds-a11y@3.15.0
```
...
2. Switch to the recommended umbrella at the current version: `npm install @sovereignsquad/gds@3.15.0` (it re-exports `gds-core`, `gds-theme`, and `gds-admin`, so you depend on one package instead of several). If you prefer to keep the split packages, install `@sovereignsquad/gds-core@3.15.0` / `@sovereignsquad/gds-theme@3.15.0` instead — both resolve from GitHub Packages.
