...
- current stable package line: `4.1.11`
...
Preferred `4.1.11` runtime package:
...
2. Switch to the recommended umbrella at the current version: `npm install @sovereignsquad/gds@4.1.11` (it re-exports `gds-core`, `gds-theme`, and `gds-admin`, so you depend on one package instead of several). If you prefer to keep the split packages, install `@sovereignsquad/gds-core@4.1.11` / `@sovereignsquad/gds-theme@4.1.11` instead — both resolve from GitHub Packages.
