...
- current stable package line: `3.4.12`
...
Preferred `3.4.12` runtime package after the release gate opens:
...
For the `3.4.12` release cutover, fallback assets must use tag `gds-v3.4.12` and must not be announced as the canonical path once npm verification passes.
