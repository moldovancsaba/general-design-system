...
- `npm run verify:references` — validates reference consumers, adoption manifests, official `DocsShell` usage, SSOT pattern-catalog coverage, website trust/clarity checks, and surface-presentation migration evidence
