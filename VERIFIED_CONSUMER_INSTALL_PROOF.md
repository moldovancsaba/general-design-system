...
Latest published GitHub Packages baseline validated by this proof: `3.14.8`
...
Canonical `3.14.8` end-state install source after the release gate opens:

```bash
npm install @sovereignsquad/gds@3.14.8
npm install -D @sovereignsquad/gds-eslint-config@3.14.8 @sovereignsquad/gds-compliance@3.14.8 @sovereignsquad/gds-a11y@3.14.8
```
