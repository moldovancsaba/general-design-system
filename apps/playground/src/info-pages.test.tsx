...
describe('playground overview page', () => {
  ...
  it('renders fully localized install copy for de and fr locales', () => {
    ...
    expect(screen.getByText('Öffentlicher 3.4.11-Installationspfad')).toBeTruthy();
    expect(screen.getAllByText(/@doneisbetter\/gds@3.4.11/).length).toBeGreaterThan(0);
    ...
    expect(screen.getByText('Parcours d’installation public 3.4.11')).toBeTruthy();
  });
