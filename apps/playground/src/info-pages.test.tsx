...
describe('playground overview page', () => {
  ...
  it('renders fully localized install copy for de and fr locales', () => {
    ...
    expect(screen.getByText('Öffentlicher 4.1.3-Installationspfad')).toBeTruthy();
    expect(screen.getAllByText(/@sovereignsquad\/gds@4.1.3/).length).toBeGreaterThan(0);
    ...
    expect(screen.getByText('Parcours d’installation public 4.1.3')).toBeTruthy();
  });
