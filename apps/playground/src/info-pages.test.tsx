...
describe('playground overview page', () => {
  ...
  it('renders fully localized install copy for de and fr locales', () => {
    ...
    expect(screen.getByText('Öffentlicher 3.0.4-Installationspfad')).toBeTruthy();
    expect(screen.getAllByText(/@doneisbetter\/gds@3.0.4/).length).toBeGreaterThan(0);
    ...
    expect(screen.getByText('Parcours d’installation public 3.0.4')).toBeTruthy();
  });
