...
describe('playground overview page', () => {
  ...
  it('renders fully localized install copy for de and fr locales', () => {
    ...
    expect(screen.getByText('Öffentlicher 6.0.0-Installationspfad')).toBeTruthy();
    expect(screen.getAllByText(/@sovereignsquad\/gds@6.0.0/).length).toBeGreaterThan(0);
    ...
    expect(screen.getByText('Parcours d’installation public 6.0.0')).toBeTruthy();
  });
