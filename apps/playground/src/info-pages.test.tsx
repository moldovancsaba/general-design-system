...
describe('playground overview page', () => {
  ...
  it('renders fully localized install copy for de and fr locales', () => {
    ...
    expect(screen.getByText('Öffentlicher 3.10.0-Installationspfad')).toBeTruthy();
    expect(screen.getAllByText(/@sovereignsquad\/gds@3.10.0/).length).toBeGreaterThan(0);
    ...
    expect(screen.getByText('Parcours d’installation public 3.10.0')).toBeTruthy();
  });
