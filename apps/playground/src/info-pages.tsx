...
const stableGdsVersion = '3.0.4';
const targetGdsVersion = '3.0.4';
...
export function InstallPage() {
  ...
  const installCopy = {
    en: {
      title: 'Install GDS',
      eyebrow: '3.0.4 public install path',
    ...
    de: {
      ...
      eyebrow: 'Öffentlicher 3.0.4-Installationspfad',
    ...
    fr: {
      title: 'Installer GDS',
      eyebrow: 'Parcours d’installation public 3.0.4',
    ...
    it: {
      ...
      lead: 'Usa il pacchetto npm umbrella come punto di ingresso pubblico predefinito, soddisfa la linea peer condivisa di Mantine, configura il provider una sola volta e allinea la governance del tema alle regole canoniche `3.0.4`.',
      ...
      upgradeSectionTitle: '2. Aggiorna i client esistenti alla 3.0.4',
    ...
    ru: {
      ...
      lead: 'Используйте umbrella npm-пакет как основной публичный вход, соблюдайте общую peer-линейку Mantine, подключите provider один раз и выровняйте владение темой по каноническим правилам `3.0.4`.',
      ...
      upgradeSectionTitle: '2. Обновите существующие клиенты до 3.0.4',
    ...
    he: {
      ...
      lead: 'השתמשו בחבילת npm umbrella כנקודת הכניסה הציבורית, השלימו את קו ה-peer של Mantine, הגדירו provider פעם אחת ויישרו את בעלות התמה לכללי `3.0.4` הקנוניים.',
      ...
      upgradeSectionTitle: '2. עדכון לקוחות קיימים ל-3.0.4',
    ...
    ar: {
      ...
      lead: 'استخدم حزمة npm الشاملة كنقطة الدخول العامة الافتراضية، ثم التزم بخط peer الخاص بـ Mantine، واضبط المزود مرة واحدة، ووافق حوكمة الثيم مع قواعد `3.0.4` القياسية.',
      ...
      upgradeSectionTitle: '2. تحديث العملاء الحاليين إلى 3.0.4',
    ...
    hu: {
      ...
      lead: 'Használd az umbrella npm csomagot alapértelmezett nyilvános belépési pontként, teljesítsd a közös Mantine peer sort, kösd be egyszer a providert, és igazítsd a téma-tulajdonlást a kanonikus `3.0.4` szabályokhoz.',
      ...
      upgradeSectionTitle: '2. Meglévő kliensek frissítése 3.0.4-re',
...
export function RulebookPage() {
  ...
  const copy = locale === 'de'
    ? {
        ...
        changedTitle: 'Was sich in 3.0.4 geändert hat',
    ...
    : locale === 'fr'
      ? {
          ...
          changedTitle: 'Ce qui a changé en 3.0.4',
      ...
      : locale === 'it'
        ? {
            ...
            changedTitle: 'Cosa è cambiato nella 3.0.4',
        ...
        : locale === 'ru'
          ? {
              ...
              changedTitle: 'Что изменилось в 3.0.4',
          ...
          : locale === 'he'
            ...
            : locale === 'ar'
              ? {
                  ...
                  changedTitle: 'ما الذي تغير في 3.0.4',
              ...
              : locale === 'hu'
                ? {
                    ...
                    changedTitle: 'Mi változott a 3.0.4-ben',
      ...
      : {
          ...
          changedTitle: 'What changed in 3.0.4',
...
export function TokensPage({
  ...
  const copy = {
    en: {
      ...
      lanesDescription: 'These are the only canonical theme ownership paths we recommend to client teams on `3.0.4`.',
    ...
    de: {
      ...
      lanesDescription: 'Das sind die einzigen kanonischen Theme-Ownership-Pfade, die wir Client-Teams in `3.0.4` empfehlen.',
    ...
    fr: {
      ...
      lanesDescription: 'Ce sont les seuls chemins canoniques de propriété du thème recommandés aux équipes clientes en `3.0.4`.',
    ...
    it: {
      ...
      lanesDescription: 'Questi sono gli unici percorsi canonici di proprietà tema raccomandati ai team client su `3.0.4`.',
    ...
    ru: {
      ...
      lanesDescription: 'Это единственные канонические пути владения темой, рекомендуемые клиентам на `3.0.4`.',
    ...
    he: {
      ...
      lanesDescription: 'אלה נתיבי בעלות התמה הקנוניים היחידים המומלצים לצוותי לקוח ב-`3.0.4`.',
    ...
    ar: {
      ...
      lanesDescription: 'هذه هي مسارات ملكية الثيم القياسية الوحيدة الموصى بها لفرق العملاء على `3.0.4`.',
    ...
    hu: {
      ...
      lanesDescription: 'Ezek az egyetlen kanonikus téma-tulajdonlási utak, amelyeket a klienscsapatoknak ajánlunk `3.0.4` alatt.',
        ...
        <FeatureBand
          ...
          items={[
            ...
            },
            {
              ...
              description: 'Run build, tests, and gds-compliance after moving to the 3.0.4 line.',
            },
          ]}
        />
      </ReferenceSection>
