...
export const installCopy = {
    en: {
      title: 'Install GDS',
      eyebrow: '3.14.16 public install path',
    ...
    de: {
      ...
      eyebrow: 'Öffentlicher 3.14.16-Installationspfad',
    ...
    fr: {
      title: 'Installer GDS',
      eyebrow: 'Parcours d’installation public 3.14.16',
    ...
    it: {
      ...
      lead: 'Usa il pacchetto npm umbrella come punto di ingresso pubblico predefinito, soddisfa la linea peer condivisa di Mantine, configura il provider una sola volta e allinea la governance del tema alle regole canoniche `3.14.16`.',
      ...
      upgradeSectionTitle: '2. Aggiorna i client esistenti alla 3.14.16',
    ...
    es: {
      title: 'Instalar GDS',
      eyebrow: 'Ruta pública de instalación 3.14.16',
    ...
    ru: {
      ...
      lead: 'Используйте umbrella npm-пакет как основной публичный вход, соблюдайте общую peer-линейку Mantine, подключите provider один раз и выровняйте владение темой по каноническим правилам `3.14.16`.',
      ...
      upgradeSectionTitle: '2. Обновите существующие клиенты до 3.14.16',
    ...
    he: {
      ...
      lead: 'השתמשו בחבילת npm umbrella כנקודת הכניסה הציבורית, השלימו את קו ה-peer של Mantine, הגדירו provider פעם אחת ויישרו את בעלות התמה לכללי `3.14.16` הקנוניים.',
      ...
      upgradeSectionTitle: '2. עדכון לקוחות קיימים ל-3.14.16',
    ...
    ar: {
      ...
      lead: 'استخدم حزمة npm الشاملة كنقطة الدخول العامة الافتراضية، ثم التزم بخط peer الخاص بـ Mantine، واضبط المزود مرة واحدة، ووافق حوكمة الثيم مع قواعد `3.14.16` القياسية.',
      ...
      upgradeSectionTitle: '2. تحديث العملاء الحاليين إلى 3.14.16',
    ...
    hu: {
      ...
      lead: 'Használd az umbrella npm csomagot alapértelmezett nyilvános belépési pontként, teljesítsd a közös Mantine peer sort, kösd be egyszer a providert, és igazítsd a téma-tulajdonlást a kanonikus `3.14.16` szabályokhoz.',
      ...
      upgradeSectionTitle: '2. Meglévő kliensek frissítése 3.14.16-re',
...
export const rulebookCopy = {
    en: {
      ...
      changedTitle: 'What changed in 3.14.16',
      changedDescription: 'Dependency governance is now explicit, and the 3.14 line adds server-paginated, collapsible Kanban columns with per-column footers, GdsSchemaForm checkbox-group and repeatable-field primitives, opt-in date-component CSS, a label-based issue board, forced-colors hardening across every theme lane, a Theme Lab whose result surfaces re-theme like any built-in preset, and a consumer WCAG contrast checker (getGdsContrastRatio / checkGdsContrast) for scoring your own color pairs against AA/AAA.',
    ...
    de: {
      ...
      changedTitle: 'Was sich in 3.14.16 geändert hat',
      changedDescription: 'Die 3.14-Linie ergänzt server-paginierte, einklappbare Kanban-Spalten mit Fußzeilen pro Spalte, GdsSchemaForm-Primitive für checkbox-group und wiederholbare Felder, optionales Date-Component-CSS, ein label-basiertes Issue-Board, Forced-Colors-Härtung über alle Theme-Lanes, ein Theme Lab, dessen Ergebnisflächen sich wie jedes eingebaute Preset umfärben, und einen WCAG-Kontrastprüfer für Konsumenten (getGdsContrastRatio / checkGdsContrast), um eigene Farbpaare gegen AA/AAA zu bewerten.',
    ...
    fr: {
      ...
      changedTitle: 'Ce qui a changé en 3.14.16',
      changedDescription: 'La ligne 3.14 ajoute des colonnes Kanban paginées côté serveur et repliables avec pied de page par colonne, les primitives GdsSchemaForm checkbox-group et champs répétables, un CSS de composant date optionnel, un tableau de bord basé sur des labels, un durcissement forced-colors sur toutes les theme lanes, un Theme Lab dont les surfaces de résultat se re-thématisent comme tout preset intégré, et un vérificateur de contraste WCAG pour les consommateurs (getGdsContrastRatio / checkGdsContrast) permettant d’évaluer vos propres paires de couleurs face à AA/AAA.',
    ...
    it: {
      ...
      changedTitle: 'Cosa è cambiato nella 3.14.16',
      changedDescription: 'La linea 3.14 aggiunge colonne Kanban paginate lato server e comprimibili con footer per colonna, le primitive GdsSchemaForm checkbox-group e campi ripetibili, CSS opzionale per i componenti data, una board basata su label, il rafforzamento forced-colors su tutte le theme lane, un Theme Lab le cui superfici dei risultati si ri-tematizzano come qualsiasi preset integrato e un verificatore di contrasto WCAG per i consumatori (getGdsContrastRatio / checkGdsContrast) per valutare le proprie coppie di colori rispetto ad AA/AAA.',
    ...
    es: {
      ...
      changedTitle: 'Qué cambió en 3.14.16',
      changedDescription: 'La línea 3.14 añade columnas Kanban paginadas en servidor y plegables con pie por columna, las primitivas GdsSchemaForm checkbox-group y campos repetibles, CSS opcional para componentes de fecha, un tablero basado en etiquetas, refuerzo forced-colors en todas las theme lanes, un Theme Lab cuyas superficies de resultado se re-tematizan como cualquier preset integrado y un verificador de contraste WCAG para consumidores (getGdsContrastRatio / checkGdsContrast) para evaluar tus propios pares de color frente a AA/AAA.',
    ...
    ru: {
      ...
      changedTitle: 'Что изменилось в 3.14.16',
      changedDescription: 'Линия 3.14 добавляет серверную пагинацию и сворачиваемые колонки Kanban с футером у каждой колонки, примитивы GdsSchemaForm checkbox-group и повторяемые поля, опциональный CSS для date-компонентов, доску на основе меток, усиление forced-colors во всех theme lane, Theme Lab, чьи поверхности результатов перекрашиваются, как любой встроенный пресет, и потребительский проверщик контраста WCAG (getGdsContrastRatio / checkGdsContrast) для оценки собственных пар цветов по AA/AAA.',
    ...
    he: {
      ...
      changedTitle: 'מה השתנה ב-3.14.16',
      changedDescription: 'קו 3.14 מוסיף עמודות Kanban עם עימוד בצד השרת וקיפול וכותרת תחתונה לכל עמודה, פרימיטיבים של GdsSchemaForm מסוג checkbox-group ושדות חוזרים, CSS אופציונלי לרכיבי תאריך, לוח מבוסס תוויות, חיזוק forced-colors בכל ה-theme lanes, Theme Lab שמשטחי התוצאה שלו מקבלים ערכת נושא כמו כל preset מובנה, ובודק ניגודיות WCAG לצרכנים (getGdsContrastRatio / checkGdsContrast) לניקוד זוגות צבעים משלך מול AA/AAA.',
    ...
    ar: {
      ...
      changedTitle: 'ما الذي تغير في 3.14.16',
      changedDescription: 'يضيف خط 3.14 أعمدة Kanban بترقيم صفحات من الخادم وقابلة للطي مع تذييل لكل عمود، وبدائل GdsSchemaForm من نوع checkbox-group والحقول القابلة للتكرار، وCSS اختياري لمكوّنات التاريخ، ولوحة قائمة على التسميات، وتقوية forced-colors عبر جميع theme lanes، وTheme Lab تُعيد أسطح نتائجه التنسيق مثل أي preset مدمج، ومدقّق تباين WCAG للمستهلكين (getGdsContrastRatio / checkGdsContrast) لتقييم أزواج الألوان الخاصة بك مقابل AA/AAA.',
    ...
    hu: {
      ...
      changedTitle: 'Mi változott a 3.14.16-ben',
      changedDescription: 'A 3.14-es vonal szerver-lapozású, összecsukható Kanban-oszlopokat ad oszloponkénti lábléccel, GdsSchemaForm checkbox-group és ismételhető mező primitíveket, opcionális date-komponens CSS-t, címke-alapú issue-boardot, forced-colors megerősítést minden theme lane-en, egy Theme Labet, amelynek eredményfelületei úgy témázódnak át, mint bármelyik beépített preset, valamint egy fogyasztói WCAG kontrasztellenőrzőt (getGdsContrastRatio / checkGdsContrast) a saját színpárjaid AA/AAA elleni pontozásához.',
...
export const tokensCopy = {
    en: {
      ...
      lanesDescription: 'These are the only canonical theme ownership paths we recommend to client teams on `3.14.16`.',
    ...
    de: {
      ...
      lanesDescription: 'Das sind die einzigen kanonischen Theme-Ownership-Pfade, die wir Client-Teams in `3.14.16` empfehlen.',
    ...
    fr: {
      ...
      lanesDescription: 'Ce sont les seuls chemins canoniques de propriété du thème recommandés aux équipes clientes en `3.14.16`.',
    ...
    it: {
      ...
      lanesDescription: 'Questi sono gli unici percorsi canonici di proprietà tema raccomandati ai team client su `3.14.16`.',
    ...
    es: {
      ...
      lanesDescription: 'Estas son las únicas rutas canónicas de ownership de tema que recomendamos a los equipos clientes en `3.14.16`.',
    ...
    ru: {
      ...
      lanesDescription: 'Это единственные канонические пути владения темой, рекомендуемые клиентам на `3.14.16`.',
    ...
    he: {
      ...
      lanesDescription: 'אלה נתיבי בעלות התמה הקנוניים היחידים המומלצים לצוותי לקוח ב-`3.14.16`.',
    ...
    ar: {
      ...
      lanesDescription: 'هذه هي مسارات ملكية الثيم القياسية الوحيدة الموصى بها لفرق العملاء على `3.14.16`.',
    ...
    hu: {
      ...
      lanesDescription: 'Ezek az egyetlen kanonikus téma-tulajdonlási utak, amelyeket a klienscsapatoknak ajánlunk `3.14.16` alatt.',
...
export const themePageLists = {
    en: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Verify after updating', description: 'Run build, tests, and gds-compliance after moving to the 3.14.16 line.' },
      ],
      links: [
    ...
    de: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Nach dem Update verifizieren', description: 'Führe Build, Tests und gds-compliance nach dem Wechsel auf die 3.14.16-Linie aus.' },
      ],
      links: [
    ...
    es: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Verificar después de actualizar', description: 'Ejecuta build, tests y gds-compliance tras pasar a la línea 3.14.16.' },
      ],
      links: [
    ...
    hu: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Frissítés után ellenőrzés', description: 'Futtass buildet, teszteket és gds-compliance-t a 3.14.16 vonalra váltás után.' },
      ],
      links: [
...
export const themePageListOverrides = {
    fr: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Vérifier après mise à jour', description: 'Exécutez build, tests et gds-compliance après le passage à la ligne 3.14.16.' },
      ],
      links: [
    ...
    it: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Verifica dopo l’aggiornamento', description: 'Esegui build, test e gds-compliance dopo il passaggio alla linea 3.14.16.' },
      ],
      links: [
    ...
    ru: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Проверить после обновления', description: 'Запустите build, tests и gds-compliance после перехода на линию 3.14.16.' },
      ],
      links: [
    ...
    he: {
      ...
      care: [
        ...
        { id: 'verify', title: 'לאמת אחרי עדכון', description: 'הריצו build, tests ו-gds-compliance אחרי מעבר לקו 3.14.16.' },
      ],
      links: [
    ...
    ar: {
      ...
      care: [
        ...
        { id: 'verify', title: 'تحقق بعد التحديث', description: 'شغّل build و tests و gds-compliance بعد الانتقال إلى خط 3.14.16.' },
      ],
      links: [
