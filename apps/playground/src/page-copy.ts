...
export const installCopy = {
    en: {
      title: 'Install GDS',
      eyebrow: '5.0.3 public install path',
    ...
    de: {
      ...
      eyebrow: 'Öffentlicher 5.0.3-Installationspfad',
    ...
    fr: {
      title: 'Installer GDS',
      eyebrow: 'Parcours d’installation public 5.0.3',
    ...
    it: {
      ...
      lead: 'Usa il pacchetto npm umbrella come punto di ingresso pubblico predefinito, soddisfa la linea peer condivisa di Mantine, configura il provider una sola volta e allinea la governance del tema alle regole canoniche `5.0.3`.',
      ...
      upgradeSectionTitle: '2. Aggiorna i client esistenti alla 5.0.3',
    ...
    es: {
      title: 'Instalar GDS',
      eyebrow: 'Ruta pública de instalación 5.0.3',
    ...
    ru: {
      ...
      lead: 'Используйте umbrella npm-пакет как основной публичный вход, соблюдайте общую peer-линейку Mantine, подключите provider один раз и выровняйте владение темой по каноническим правилам `5.0.3`.',
      ...
      upgradeSectionTitle: '2. Обновите существующие клиенты до 5.0.3',
    ...
    he: {
      ...
      lead: 'השתמשו בחבילת npm umbrella כנקודת הכניסה הציבורית, השלימו את קו ה-peer של Mantine, הגדירו provider פעם אחת ויישרו את בעלות התמה לכללי `5.0.3` הקנוניים.',
      ...
      upgradeSectionTitle: '2. עדכון לקוחות קיימים ל-5.0.3',
    ...
    ar: {
      ...
      lead: 'استخدم حزمة npm الشاملة كنقطة الدخول العامة الافتراضية، ثم التزم بخط peer الخاص بـ Mantine، واضبط المزود مرة واحدة، ووافق حوكمة الثيم مع قواعد `5.0.3` القياسية.',
      ...
      upgradeSectionTitle: '2. تحديث العملاء الحاليين إلى 5.0.3',
    ...
    hu: {
      ...
      lead: 'Használd az umbrella npm csomagot alapértelmezett nyilvános belépési pontként, teljesítsd a közös Mantine peer sort, kösd be egyszer a providert, és igazítsd a téma-tulajdonlást a kanonikus `5.0.3` szabályokhoz.',
      ...
      upgradeSectionTitle: '2. Meglévő kliensek frissítése 5.0.3-re',
...
export const rulebookCopy = {
    en: {
      ...
      changedTitle: 'What changed in 5.0.3',
    ...
    de: {
      ...
      changedTitle: 'Was sich in 5.0.3 geändert hat',
    ...
    fr: {
      ...
      changedTitle: 'Ce qui a changé en 5.0.3',
    ...
    it: {
      ...
      changedTitle: 'Cosa è cambiato nella 5.0.3',
    ...
    es: {
      ...
      changedTitle: 'Qué cambió en 5.0.3',
    ...
    ru: {
      ...
      changedTitle: 'Что изменилось в 5.0.3',
    ...
    ar: {
      ...
      changedTitle: 'ما الذي تغير في 5.0.3',
    ...
    hu: {
      ...
      changedTitle: 'Mi változott a 5.0.3-ben',
...
export const tokensCopy = {
    en: {
      ...
      lanesDescription: 'These are the only canonical theme ownership paths we recommend to client teams on `5.0.3`.',
    ...
    de: {
      ...
      lanesDescription: 'Das sind die einzigen kanonischen Theme-Ownership-Pfade, die wir Client-Teams in `5.0.3` empfehlen.',
    ...
    fr: {
      ...
      lanesDescription: 'Ce sont les seuls chemins canoniques de propriété du thème recommandés aux équipes clientes en `5.0.3`.',
    ...
    it: {
      ...
      lanesDescription: 'Questi sono gli unici percorsi canonici di proprietà tema raccomandati ai team client su `5.0.3`.',
    ...
    es: {
      ...
      lanesDescription: 'Estas son las únicas rutas canónicas de ownership de tema que recomendamos a los equipos clientes en `5.0.3`.',
    ...
    ru: {
      ...
      lanesDescription: 'Это единственные канонические пути владения темой, рекомендуемые клиентам на `5.0.3`.',
    ...
    he: {
      ...
      lanesDescription: 'אלה נתיבי בעלות התמה הקנוניים היחידים המומלצים לצוותי לקוח ב-`5.0.3`.',
    ...
    ar: {
      ...
      lanesDescription: 'هذه هي مسارات ملكية الثيم القياسية الوحيدة الموصى بها لفرق العملاء على `5.0.3`.',
    ...
    hu: {
      ...
      lanesDescription: 'Ezek az egyetlen kanonikus téma-tulajdonlási utak, amelyeket a klienscsapatoknak ajánlunk `5.0.3` alatt.',
...
export const themePageLists = {
    en: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Verify after updating', description: 'Run build, tests, and gds-compliance after moving to the 5.0.3 line.' },
      ],
      links: [
    ...
    de: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Nach dem Update verifizieren', description: 'Führe Build, Tests und gds-compliance nach dem Wechsel auf die 5.0.3-Linie aus.' },
      ],
      links: [
    ...
    es: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Verificar después de actualizar', description: 'Ejecuta build, tests y gds-compliance tras pasar a la línea 5.0.3.' },
      ],
      links: [
    ...
    hu: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Frissítés után ellenőrzés', description: 'Futtass buildet, teszteket és gds-compliance-t a 5.0.3 vonalra váltás után.' },
      ],
      links: [
...
export const themePageListOverrides = {
    fr: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Vérifier après mise à jour', description: 'Exécutez build, tests et gds-compliance après le passage à la ligne 5.0.3.' },
      ],
      links: [
    ...
    it: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Verifica dopo l’aggiornamento', description: 'Esegui build, test e gds-compliance dopo il passaggio alla linea 5.0.3.' },
      ],
      links: [
    ...
    ru: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Проверить после обновления', description: 'Запустите build, tests и gds-compliance после перехода на линию 5.0.3.' },
      ],
      links: [
    ...
    he: {
      ...
      care: [
        ...
        { id: 'verify', title: 'לאמת אחרי עדכון', description: 'הריצו build, tests ו-gds-compliance אחרי מעבר לקו 5.0.3.' },
      ],
      links: [
    ...
    ar: {
      ...
      care: [
        ...
        { id: 'verify', title: 'تحقق بعد التحديث', description: 'شغّل build و tests و gds-compliance بعد الانتقال إلى خط 5.0.3.' },
      ],
      links: [
