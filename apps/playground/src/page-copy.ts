...
export const installCopy = {
    en: {
      title: 'Install GDS',
      eyebrow: '3.14.5 public install path',
    ...
    de: {
      ...
      eyebrow: 'Öffentlicher 3.14.5-Installationspfad',
    ...
    fr: {
      title: 'Installer GDS',
      eyebrow: 'Parcours d’installation public 3.14.5',
    ...
    it: {
      ...
      lead: 'Usa il pacchetto npm umbrella come punto di ingresso pubblico predefinito, soddisfa la linea peer condivisa di Mantine, configura il provider una sola volta e allinea la governance del tema alle regole canoniche `3.14.5`.',
      ...
      upgradeSectionTitle: '2. Aggiorna i client esistenti alla 3.14.5',
    ...
    es: {
      title: 'Instalar GDS',
      eyebrow: 'Ruta pública de instalación 3.14.5',
    ...
    ru: {
      ...
      lead: 'Используйте umbrella npm-пакет как основной публичный вход, соблюдайте общую peer-линейку Mantine, подключите provider один раз и выровняйте владение темой по каноническим правилам `3.14.5`.',
      ...
      upgradeSectionTitle: '2. Обновите существующие клиенты до 3.14.5',
    ...
    he: {
      ...
      lead: 'השתמשו בחבילת npm umbrella כנקודת הכניסה הציבורית, השלימו את קו ה-peer של Mantine, הגדירו provider פעם אחת ויישרו את בעלות התמה לכללי `3.14.5` הקנוניים.',
      ...
      upgradeSectionTitle: '2. עדכון לקוחות קיימים ל-3.14.5',
    ...
    ar: {
      ...
      lead: 'استخدم حزمة npm الشاملة كنقطة الدخول العامة الافتراضية، ثم التزم بخط peer الخاص بـ Mantine، واضبط المزود مرة واحدة، ووافق حوكمة الثيم مع قواعد `3.14.5` القياسية.',
      ...
      upgradeSectionTitle: '2. تحديث العملاء الحاليين إلى 3.14.5',
    ...
    hu: {
      ...
      lead: 'Használd az umbrella npm csomagot alapértelmezett nyilvános belépési pontként, teljesítsd a közös Mantine peer sort, kösd be egyszer a providert, és igazítsd a téma-tulajdonlást a kanonikus `3.14.5` szabályokhoz.',
      ...
      upgradeSectionTitle: '2. Meglévő kliensek frissítése 3.14.5-re',
...
export const rulebookCopy = {
    en: {
      ...
      changedTitle: 'What changed in 3.14.5',
      changedDescription: 'Dependency governance is now explicit, and the 3.14 line adds server-paginated, collapsible Kanban columns with per-column footers, GdsSchemaForm checkbox-group and repeatable-field primitives, opt-in date-component CSS, a label-based issue board, forced-colors hardening across every theme lane, and a Theme Lab whose result surfaces re-theme like any built-in preset.',
    ...
    de: {
      ...
      changedTitle: 'Was sich in 3.14.5 geändert hat',
      changedDescription: 'Die 3.14-Linie ergänzt server-paginierte, einklappbare Kanban-Spalten mit Fußzeilen pro Spalte, GdsSchemaForm-Primitive für checkbox-group und wiederholbare Felder, optionales Date-Component-CSS, ein label-basiertes Issue-Board, Forced-Colors-Härtung über alle Theme-Lanes und ein Theme Lab, dessen Ergebnisflächen sich wie jedes eingebaute Preset umfärben.',
    ...
    ru: {
      ...
      changedTitle: 'Что изменилось в 3.14.5',
      changedDescription: 'Линия 3.14 добавляет серверную пагинацию и сворачиваемые колонки Kanban с футером у каждой колонки, примитивы GdsSchemaForm checkbox-group и повторяемые поля, опциональный CSS для date-компонентов, доску на основе меток, усиление forced-colors во всех theme lane и Theme Lab, чьи поверхности результатов перекрашиваются, как любой встроенный пресет.',
    ...
    he: {
      ...
      changedTitle: 'מה השתנה ב-3.14.5',
      changedDescription: 'קו 3.14 מוסיף עמודות Kanban עם עימוד בצד השרת וקיפול וכותרת תחתונה לכל עמודה, פרימיטיבים של GdsSchemaForm מסוג checkbox-group ושדות חוזרים, CSS אופציונלי לרכיבי תאריך, לוח מבוסס תוויות, חיזוק forced-colors בכל ה-theme lanes, ו-Theme Lab שמשטחי התוצאה שלו מקבלים ערכת נושא כמו כל preset מובנה.',
    ...
    ar: {
      ...
      changedTitle: 'ما الذي تغير في 3.14.5',
      changedDescription: 'يضيف خط 3.14 أعمدة Kanban بترقيم صفحات من الخادم وقابلة للطي مع تذييل لكل عمود، وبدائل GdsSchemaForm من نوع checkbox-group والحقول القابلة للتكرار، وCSS اختياري لمكوّنات التاريخ، ولوحة قائمة على التسميات، وتقوية forced-colors عبر جميع theme lanes، وTheme Lab تُعيد أسطح نتائجه التنسيق مثل أي preset مدمج.',
    ...
    hu: {
      ...
      changedTitle: 'Mi változott a 3.14.5-ben',
      changedDescription: 'A 3.14-es vonal szerver-lapozású, összecsukható Kanban-oszlopokat ad oszloponkénti lábléccel, GdsSchemaForm checkbox-group és ismételhető mező primitíveket, opcionális date-komponens CSS-t, címke-alapú issue-boardot, forced-colors megerősítést minden theme lane-en, és egy Theme Labet, amelynek eredményfelületei úgy témázódnak át, mint bármelyik beépített preset.',
...
export const tokensCopy = {
    en: {
      ...
      lanesDescription: 'These are the only canonical theme ownership paths we recommend to client teams on `3.14.5`.',
    ...
    de: {
      ...
      lanesDescription: 'Das sind die einzigen kanonischen Theme-Ownership-Pfade, die wir Client-Teams in `3.14.5` empfehlen.',
    ...
    fr: {
      ...
      lanesDescription: 'Ce sont les seuls chemins canoniques de propriété du thème recommandés aux équipes clientes en `3.14.5`.',
    ...
    it: {
      ...
      lanesDescription: 'Questi sono gli unici percorsi canonici di proprietà tema raccomandati ai team client su `3.14.5`.',
    ...
    es: {
      ...
      lanesDescription: 'Estas son las únicas rutas canónicas de ownership de tema que recomendamos a los equipos clientes en `3.14.5`.',
    ...
    ru: {
      ...
      lanesDescription: 'Это единственные канонические пути владения темой, рекомендуемые клиентам на `3.14.5`.',
    ...
    he: {
      ...
      lanesDescription: 'אלה נתיבי בעלות התמה הקנוניים היחידים המומלצים לצוותי לקוח ב-`3.14.5`.',
    ...
    ar: {
      ...
      lanesDescription: 'هذه هي مسارات ملكية الثيم القياسية الوحيدة الموصى بها لفرق العملاء على `3.14.5`.',
    ...
    hu: {
      ...
      lanesDescription: 'Ezek az egyetlen kanonikus téma-tulajdonlási utak, amelyeket a klienscsapatoknak ajánlunk `3.14.5` alatt.',
...
export const themePageLists = {
    en: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Verify after updating', description: 'Run build, tests, and gds-compliance after moving to the 3.14.5 line.' },
      ],
      links: [
    ...
    de: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Nach dem Update verifizieren', description: 'Führe Build, Tests und gds-compliance nach dem Wechsel auf die 3.14.5-Linie aus.' },
      ],
      links: [
    ...
    es: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Verificar después de actualizar', description: 'Ejecuta build, tests y gds-compliance tras pasar a la línea 3.14.5.' },
      ],
      links: [
    ...
    hu: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Frissítés után ellenőrzés', description: 'Futtass buildet, teszteket és gds-compliance-t a 3.14.5 vonalra váltás után.' },
      ],
      links: [
...
export const themePageListOverrides = {
    fr: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Vérifier après mise à jour', description: 'Exécutez build, tests et gds-compliance après le passage à la ligne 3.14.5.' },
      ],
      links: [
    ...
    it: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Verifica dopo l’aggiornamento', description: 'Esegui build, test e gds-compliance dopo il passaggio alla linea 3.14.5.' },
      ],
      links: [
    ...
    ru: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Проверить после обновления', description: 'Запустите build, tests и gds-compliance после перехода на линию 3.14.5.' },
      ],
      links: [
    ...
    he: {
      ...
      care: [
        ...
        { id: 'verify', title: 'לאמת אחרי עדכון', description: 'הריצו build, tests ו-gds-compliance אחרי מעבר לקו 3.14.5.' },
      ],
      links: [
    ...
    ar: {
      ...
      care: [
        ...
        { id: 'verify', title: 'تحقق بعد التحديث', description: 'شغّل build و tests و gds-compliance بعد الانتقال إلى خط 3.14.5.' },
      ],
      links: [
