...
const rawPatternRegistry: RawPatternRegistryEntry[] = [
  ...
  },
  {
    ...
    summary: 'Every BrandSemanticRole grouped by its 60-30-10 proportion classification, the governed accent axis (names, shades, enforcement per mode), and the live contrast matrix for the default preset — embedding GdsAccentContrastMatrix so this page can never disagree with verify:accent-contrast.',
    importPath: '@sovereignsquad/gds-core',
    sourceComponent: 'GdsColorSystemReference',
  },
  {
    ...
    summary: 'Every governed accessibility-floor rule (id, axis, WCAG citation, rationale) and a live audit result across all 25 presets x 2 schemes, computed by auditGdsAccessibilityFloor() — the same function verify:a11y-floor runs.',
    importPath: '@sovereignsquad/gds-core',
