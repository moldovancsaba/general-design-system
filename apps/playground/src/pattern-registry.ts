...
const rawPatternRegistry: RawPatternRegistryEntry[] = [
  ...
  },
  {
    ...
    summary: 'Six governed durations, five easings, seven named presets and the reaction axis — every value surfaced live from the exports consumers import, with reduced motion honoured by the tokens themselves.',
    importPath: '@sovereignsquad/gds-core',
