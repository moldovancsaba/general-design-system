...
const rawPatternRegistry: RawPatternRegistryEntry[] = [
  ...
  },
  {
    ...
    sourceComponent: 'DiscoveryShell',
  },
  {
  ...
  },
  {
    ...
    coverageStatus: 'live-demo',
    summary: 'Loading, empty, error, permission, disabled, and success states must explain what happened and what comes next.',
    importPath: '@doneisbetter/gds-core',
  ...
  },
  {
    ...
    importPath: '@doneisbetter/gds-admin',
    sourceComponent: 'ContentOpsEditor',
  },
  {
    id: 'section-panels',
    ...
    section: 'Dashboard & Panel Surfaces',
    coverageStatus: 'live-demo',
    summary: 'Operational panels and detail sections should reuse a shared framing contract instead of local wrappers.',
    importPath: '@doneisbetter/gds-core',
