...
export const installCopy = {
    en: {
      ...
      fallbackConsumerCodeTitle: 'Install from a release bundle (no npm registry)',
    ...
    de: {
      ...
      fallbackConsumerCodeTitle: 'Aus einem Release-Bundle installieren (ohne npm-Registry)',
    ...
    fr: {
      ...
      fallbackConsumerCodeTitle: 'Installer depuis un pack de version (sans registre npm)',
    ...
    it: {
      ...
      fallbackConsumerCodeTitle: 'Installa da un bundle di release (senza registro npm)',
    ...
    es: {
      ...
      fallbackConsumerCodeTitle: 'Instalar desde un paquete de versión (sin registro npm)',
    ...
    ru: {
      ...
      fallbackConsumerCodeTitle: 'Установка из релиз-бандла (без npm-реестра)',
    ...
    he: {
      ...
      fallbackConsumerCodeTitle: 'התקנה מחבילת release (ללא רישום npm)',
    ...
    ar: {
      ...
      fallbackConsumerCodeTitle: 'التثبيت من حزمة إصدار (بدون سجل npm)',
    ...
    hu: {
      ...
      fallbackConsumerCodeTitle: 'Telepítés release-csomagból (npm registry nélkül)',
