...
export const stableGdsVersion = '3.7.0';
export const targetGdsVersion = '3.7.0';
...
export const installCopy = {
    en: {
      title: 'Install GDS',
      eyebrow: '3.7.0 public install path',
    ...
    de: {
      ...
      eyebrow: 'Öffentlicher 3.7.0-Installationspfad',
    ...
    fr: {
      title: 'Installer GDS',
      eyebrow: 'Parcours d’installation public 3.7.0',
    ...
    it: {
      ...
      lead: 'Usa il pacchetto npm umbrella come punto di ingresso pubblico predefinito, soddisfa la linea peer condivisa di Mantine, configura il provider una sola volta e allinea la governance del tema alle regole canoniche `3.7.0`.',
      ...
      upgradeSectionTitle: '2. Aggiorna i client esistenti alla 3.7.0',
    ...
    es: {
      title: 'Instalar GDS',
      eyebrow: 'Ruta pública de instalación 3.7.0',
    ...
    ru: {
      ...
      lead: 'Используйте umbrella npm-пакет как основной публичный вход, соблюдайте общую peer-линейку Mantine, подключите provider один раз и выровняйте владение темой по каноническим правилам `3.7.0`.',
      ...
      upgradeSectionTitle: '2. Обновите существующие клиенты до 3.7.0',
    ...
    he: {
      ...
      lead: 'השתמשו בחבילת npm umbrella כנקודת הכניסה הציבורית, השלימו את קו ה-peer של Mantine, הגדירו provider פעם אחת ויישרו את בעלות התמה לכללי `3.7.0` הקנוניים.',
      ...
      upgradeSectionTitle: '2. עדכון לקוחות קיימים ל-3.7.0',
    ...
    ar: {
      ...
      lead: 'استخدم حزمة npm الشاملة كنقطة الدخول العامة الافتراضية، ثم التزم بخط peer الخاص بـ Mantine، واضبط المزود مرة واحدة، ووافق حوكمة الثيم مع قواعد `3.7.0` القياسية.',
      ...
      upgradeSectionTitle: '2. تحديث العملاء الحاليين إلى 3.7.0',
    ...
    hu: {
      ...
      lead: 'Használd az umbrella npm csomagot alapértelmezett nyilvános belépési pontként, teljesítsd a közös Mantine peer sort, kösd be egyszer a providert, és igazítsd a téma-tulajdonlást a kanonikus `3.7.0` szabályokhoz.',
      ...
      upgradeSectionTitle: '2. Meglévő kliensek frissítése 3.7.0-re',
...
export const rulebookCopy = {
    en: {
      ...
      changedTitle: 'What changed in 3.7.0',
    ...
    de: {
      ...
      changedTitle: 'Was sich in 3.7.0 geändert hat',
    ...
    fr: {
      ...
      changedTitle: 'Ce qui a changé en 3.7.0',
    ...
    it: {
      ...
      changedTitle: 'Cosa è cambiato nella 3.7.0',
    ...
    es: {
      ...
      changedTitle: 'Qué cambió en 3.7.0',
    ...
    ru: {
      ...
      changedTitle: 'Что изменилось в 3.7.0',
    ...
    ar: {
      ...
      changedTitle: 'ما الذي تغير في 3.7.0',
    ...
    hu: {
      ...
      changedTitle: 'Mi változott a 3.7.0-ben',
...
export const tokensCopy = {
    en: {
      ...
      lanesDescription: 'These are the only canonical theme ownership paths we recommend to client teams on `3.7.0`.',
    ...
    de: {
      ...
      lanesDescription: 'Das sind die einzigen kanonischen Theme-Ownership-Pfade, die wir Client-Teams in `3.7.0` empfehlen.',
    ...
    fr: {
      ...
      lanesDescription: 'Ce sont les seuls chemins canoniques de propriété du thème recommandés aux équipes clientes en `3.7.0`.',
    ...
    it: {
      ...
      lanesDescription: 'Questi sono gli unici percorsi canonici di proprietà tema raccomandati ai team client su `3.7.0`.',
    ...
    es: {
      ...
      lanesDescription: 'Estas son las únicas rutas canónicas de ownership de tema que recomendamos a los equipos clientes en `3.7.0`.',
    ...
    ru: {
      ...
      lanesDescription: 'Это единственные канонические пути владения темой, рекомендуемые клиентам на `3.7.0`.',
    ...
    he: {
      ...
      lanesDescription: 'אלה נתיבי בעלות התמה הקנוניים היחידים המומלצים לצוותי לקוח ב-`3.7.0`.',
    ...
    ar: {
      ...
      lanesDescription: 'هذه هي مسارات ملكية الثيم القياسية الوحيدة الموصى بها لفرق العملاء على `3.7.0`.',
    ...
    hu: {
      ...
      lanesDescription: 'Ezek az egyetlen kanonikus téma-tulajdonlási utak, amelyeket a klienscsapatoknak ajánlunk `3.7.0` alatt.',
...
export const themePageLists = {
    en: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Verify after updating', description: 'Run build, tests, and gds-compliance after moving to the 3.7.0 line.' },
      ],
      links: [
    ...
    de: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Nach dem Update verifizieren', description: 'Führe Build, Tests und gds-compliance nach dem Wechsel auf die 3.7.0-Linie aus.' },
      ],
      links: [
    ...
    es: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Verificar después de actualizar', description: 'Ejecuta build, tests y gds-compliance tras pasar a la línea 3.7.0.' },
      ],
      links: [
    ...
    hu: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Frissítés után ellenőrzés', description: 'Futtass buildet, teszteket és gds-compliance-t a 3.7.0 vonalra váltás után.' },
      ],
      links: [
...
export const themePageListOverrides = {
    fr: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Vérifier après mise à jour', description: 'Exécutez build, tests et gds-compliance après le passage à la ligne 3.7.0.' },
      ],
      links: [
    ...
    it: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Verifica dopo l’aggiornamento', description: 'Esegui build, test e gds-compliance dopo il passaggio alla linea 3.7.0.' },
      ],
      links: [
    ...
    ru: {
      ...
      care: [
        ...
        { id: 'verify', title: 'Проверить после обновления', description: 'Запустите build, tests и gds-compliance после перехода на линию 3.7.0.' },
      ],
      links: [
    ...
    he: {
      ...
      care: [
        ...
        { id: 'verify', title: 'לאמת אחרי עדכון', description: 'הריצו build, tests ו-gds-compliance אחרי מעבר לקו 3.7.0.' },
      ],
      links: [
    ...
    ar: {
      ...
      care: [
        ...
        { id: 'verify', title: 'تحقق بعد التحديث', description: 'شغّل build و tests و gds-compliance بعد الانتقال إلى خط 3.7.0.' },
      ],
      links: [
