...
| Lane | Where | Use when |
|---|---|---|
| **Current major (live)** | This repository's `main` + the live site at [sovereignsquad.github.io/general-design-system](https://sovereignsquad.github.io/general-design-system) | You're on the current major (`4.x`). |
...
- **Current major — 4.x** (supported): [`main` docs](https://github.com/sovereignsquad/general-design-system/tree/main) · [live site](https://sovereignsquad.github.io/general-design-system) · latest release tag `gds-v4.1.11`.
