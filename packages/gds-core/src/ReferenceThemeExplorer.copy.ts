...
const explorerGeneratedLocalePacks = {
  es: {
    ...
    forcedDarkPreview: 'Este carril siempre se previsualiza en modo oscuro para mantener el contrato de contraste aprobado.',
  ...
  fr: {
    ...
    forcedDarkPreview: 'Cette lane est toujours prévisualisée en mode sombre pour préserver son contrat de contraste.',
  ...
  it: {
    ...
    forcedDarkPreview: 'Questa lane viene sempre mostrata in dark mode per mantenere il contratto di contrasto.',
  ...
  ru: {
    ...
    darkForwardNotice: 'Этот dark-forward пресет всегда отображается в темном режиме в live-предпросмотре.',
    ...
    forcedDarkPreview: 'Эта линия всегда просматривается в темном режиме, чтобы сохранить утвержденный контракт контраста.',
  ...
  he: {
    ...
    darkForwardNotice: 'Preset זה מוצג תמיד במצב כהה בתצוגה החיה.',
    ...
    forcedDarkPreview: 'נתיב זה תמיד מוצג במצב כהה כדי לשמור על חוזה הקונטרסט המאושר.',
  ...
  ar: {
    ...
    darkForwardNotice: 'يعرض هذا الإعداد دائماً في الوضع الداكن داخل المعاينة الحية.',
    ...
    forcedDarkPreview: 'يُعرض هذا المسار دائماً في الوضع الداكن للحفاظ على عقد التباين المعتمد.',
